    ...
    function setupMainTabScrub() {
      ...
      function resetScrub(activate = false) {
        ...
        window.requestAnimationFrame(() => {
          ...
          window.setTimeout(() => mobileNavigation.classList.remove("nav-settling"), 460);
        });
      }
