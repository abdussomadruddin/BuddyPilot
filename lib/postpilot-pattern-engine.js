...
const OPENERS = {
  ...
  insight: [
    ...
    "lagi lama aku buat benda ni, lagi jelas satu perkara",
...
const MIDDLES = [
  ...
  "benda ni nampak basic, tapi basic yang konsisten memang jalan",
];
...
function buildLines({ family, platform, product, topic, tone, audience, personalBackground, angleNote, profile, rng }) {
  ...
  const audienceLine = audience ? sentence(`kalau kau ${audience}, benda ni memang senang terlepas pandang`) : "";
