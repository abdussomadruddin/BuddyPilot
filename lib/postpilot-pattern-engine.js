...
const OPERATOR_PROMOTE_FLOW = Object.freeze({
  antiHype: [
    ...
    "aku tak nak puji benda ni kosong-kosong",
    "aku tengok benda ni bukan sebab nak ikut hype",
    "aku tak terus anggap semua offer yang nampak menarik tu bagus",
    "aku cuba tengok benda ni dengan kepala sejuk dulu",
  ],
  potential: [
