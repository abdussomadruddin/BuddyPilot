...
const OPERATOR_OPENING_ACTIONS = Object.freeze([
  "aku baru lepas tengok",
  "aku baru sempat tengok",
  "aku baru habis baca",
  "aku baru belek",
  "aku sempat belek",
  "aku singgah tengok",
  "aku duduk baca",
  "aku ambil masa tengok",
  "aku cuba faham",
  "aku baca pelan-pelan",
  "aku tengok sekali lalu",
  "aku tengok sampai habis",
  "aku buka dan baca",
  "aku ternampak",
  "aku terjumpa",
  "aku baru perasan",
  ...
  "aku sempat check",
  "aku cuba check",
  "aku berhenti scroll sebab nampak",
  "aku baca balik",
  "aku tengok balik",
  "aku buka balik",
  "aku fikir balik pasal",
  "aku nak share pasal",
  "aku nak sembang pasal",
  "aku nak cakap sikit pasal",
  "aku nak cerita sikit pasal",
  "aku nak bagi pandangan pasal",
  "jujur, aku tertarik dengan",
  "jujur, aku curious pasal",
  "jujur, aku tak terus percaya",
  "jujur, aku mula-mula biasa je dengan",
  "mula-mula aku lalu je dekat",
  "mula-mula aku tak fikir banyak pasal",
  "mula-mula aku ingat biasa je",
  "tadi aku ada tengok",
  "tadi aku sempat baca",
  "tadi aku belek",
  "semalam aku ada tengok",
  "semalam aku sempat baca",
  "sekejap tadi aku tengok",
  "sekejap tadi aku baca",
  "pagi tadi aku sempat tengok",
  "malam tadi aku ada baca",
  "aku bukan nak hypekan",
  "aku bukan nak puji kosong-kosong",
  "aku tak nak overclaim pasal",
  "aku nak cakap terus terang pasal",
]);

const OPERATOR_OPENING_OBJECTS = Object.freeze([
  "benda ni",
  "offer ni",
  "produk ni",
  "salespage ni",
  "apa yang dia cuba buat",
  "cara benda ni disusun",
  "idea di sebalik benda ni",
  "flow yang dia tunjuk",
  "apa yang ditawarkan",
  "cara offer ni diterangkan",
]);

const OPERATOR_PROMOTE_OPENINGS = Object.freeze(
  OPERATOR_OPENING_ACTIONS.flatMap((action) =>
    OPERATOR_OPENING_OBJECTS.map((object) => `${action} ${object}`)
  )
);

const OPERATOR_PROMOTE_FLOW = Object.freeze({
  antiHype: OPERATOR_PROMOTE_OPENINGS,
  potential: [
    "{product} ni, pada pandangan aku, ada potensi bantu orang yang dah cuba bergerak tapi masih belum nampak flow yang betul",
    "bila aku tengok {product}, aku rasa benda ni boleh bantu orang yang dah ada usaha, cuma sistem dia masih bersepah",
    "{product} ni nampak sesuai untuk orang yang bukan tak mahu buat, tapi masih tak jelas apa yang patut disusun dahulu",
    "daripada apa yang aku nampak, {product} boleh jadi starting point untuk orang yang dah penat cuba banyak benda tanpa arah yang jelas",
    "pada aku, nilai {product} bukan dekat rupa offer dia sahaja, tapi dekat cara dia bantu orang nampak apa yang selama ni terlepas",
  ],
  why: [
    "kenapa aku cakap macam ni?",
    "kenapa aku berhenti dan tengok benda ni lama sikit?",
    "apa yang buat aku rasa benda ni patut diberi perhatian?",
    "jadi apa sebenarnya yang aku nampak dekat sini?",
    "kenapa aku tak terus scroll macam biasa?",
  ],
  notBecause: [
    "bukan sebab poster dia nampak cantik.\nbukan sebab ayat salespage dia sedap dibaca.\nbukan juga sebab orang tengah bercakap pasal benda yang sama",
    "bukan sebab nama dia menarik.\nbukan sebab offer dia nampak besar.\nbukan sebab aku nak percaya semua benda yang ditulis dekat salespage",
    "bukan sebab tools dia banyak.\nbukan sebab bonus dia panjang.\nbukan sebab janji yang nampak mudah atas kertas",
    "bukan sebab benda ni nampak baru.\nbukan sebab orang lain kata bagus.\nbukan sebab aku suka beli benda ikut trend",
    "bukan sebab marketing dia kuat.\nbukan sebab wording dia kemas.\nbukan sebab satu dua screenshot boleh terus buktikan semuanya",
  ],
  operatorLens: [
    "tapi sebab sistem selepas orang mula buat",
    "tapi sebab cara semua langkah tu disambungkan",
    "tapi sebab apa yang berlaku selepas perhatian pertama dah diperoleh",
    "tapi sebab execution selepas orang dah faham apa yang dia mahu",
    "tapi sebab benda kecil yang menentukan usaha tu bergerak atau bocor",
  ],
  marketShift: [
    "sekarang ramai orang boleh buat content.\nramai orang boleh run ads.\nramai orang boleh launch offer.\nAI pun dah mudahkan banyak kerja yang dulu makan masa",
    "hari ni nak hasilkan content dah makin mudah.\nnak setup kempen pun ramai dah boleh buat.\nnak cari idea atau siapkan bahan pun AI boleh bantu",
    "sekarang tools makin banyak.\ntutorial ada dekat mana-mana.\ncontent boleh siap cepat.\ntraffic pun boleh dibeli kalau ada budget",
    "dulu masalah besar mungkin nak mula.\nsekarang ramai dah boleh mula.\nramai dah boleh tarik perhatian.\nramai juga dah boleh bawa orang masuk dalam funnel",
    "hari ni hampir semua orang ada akses kepada tools yang sama.\nAI yang sama.\nplatform yang sama.\ndan cara belajar yang jauh lebih cepat",
  ],
  realProblem: [
    "jadi masalah paling besar bukan semata-mata nak dapat perhatian.\nmasalah sebenar ialah macam mana nak tukarkan perhatian tu jadi tindakan dan jualan",
    "sebab itu ramai nampak sibuk, tapi hasil masih tak bergerak.\ntraffic masuk, tetapi perjalanan selepas itu tak cukup jelas",
    "dekat sinilah ramai mula bocor.\norang dah nampak, dah klik, malah dah bertanya, tapi tak cukup sebab untuk terus membuat keputusan",
    "masalah sebenar selalu muncul selepas orang mula berminat.\napa yang dia nampak, apa yang dia faham dan apa yang buat dia yakin",
    "ramai bukan kurang usaha.\nramai cuma belum ada susunan yang boleh bawa prospek daripada curious kepada yakin",
  ],
  verdict: [
    "jadi benda ni bagus ke?\n\njawapan aku...\nbagus.\n\ntapi dengan satu syarat.\nkena ada strategi",
    "jadi berbaloi ke nak tengok?\n\npada aku...\nberbaloi.\n\ntapi jangan masuk dengan harapan tools akan buat semua kerja.\nstrategi tetap kena ada",
    "aku rasa benda ni boleh jalan ke?\n\nboleh.\n\ntapi execution kena betul.\nkalau sekadar kumpul bahan tanpa guna, hasil dia tetap sama",
    "jadi aku setuju dengan pendekatan ni?\n\nya.\n\ntapi bukan secara membuta tuli.\nkena faham kenapa setiap langkah dibuat",
    "jawapan pendek aku...\nbenda ni ada value.\n\ntapi value tu hanya keluar bila orang betul-betul guna dengan strategi",
  ],
  strategy: [
    "strategi macam mana nak susun flow.\nstrategi macam mana nak tapis orang yang betul-betul berminat.\nstrategi macam mana nak follow up tanpa nampak memaksa.\nstrategi macam mana nak bagi orang faham value sebelum dia decide.\nstrategi macam mana nak scale tanpa bakar masa dan budget",
    "kena tahu siapa yang kita nak tarik.\nkena tahu apa yang dia masih tak faham.\nkena tahu bila nak educate dan bila nak buat offer.\nkena tahu dekat mana prospek selalu hilang.\nkena tahu apa yang patut dibaiki sebelum tambah budget",
    "bukan sekadar buat content.\nbukan sekadar tekan publish.\nbukan sekadar dapat klik.\nkena nampak perjalanan penuh daripada perhatian sampai orang yakin nak bertindak",
    "kena susun mesej.\nkena jaga expectation.\nkena follow up dengan context.\nkena tengok nombor yang betul.\nkena tahu bila patut teruskan dan bila patut ubah",
    "strategi bukan benda yang nampak hebat dalam slide.\nstrategi ialah keputusan kecil yang menentukan apa dibuat dulu, apa dibuang dan apa yang patut diulang",
  ],
  durableThinking: [
    "tools akan berubah.\nAI akan berubah.\nplatform akan berubah.\n\ntapi cara berfikir yang betul akan tahan lebih lama",
    "template boleh lapuk.\nfeature boleh berubah.\nplatform boleh tukar rules.\n\ntapi orang yang faham asas masih boleh menyesuaikan diri",
    "sebab itu benda paling mahal bukan semata-mata template atau tools.\nbenda paling mahal ialah cara berfikir masa buat keputusan",
    "operator tak boleh fikir cantik sahaja.\nkena fikir apa yang boleh dibuat, diukur, dibaiki dan diulang",
    "bila faham kenapa sesuatu langkah dibuat, kita tak mudah panik setiap kali platform berubah",
  ],
  review: [
    "kalau memang nak mula atau nak betulkan benda yang masih sangkut, baca salespage dia dengan tenang.\n\njangan decide daripada poster sahaja.\nsemak apa yang disediakan.\ntengok modul, bonus, harga dan syarat kalau ada.\npastikan ia sesuai dengan situasi kau sekarang",
    "kalau benda ni memang dekat dengan masalah yang kau sedang hadap, jangan tengok headline sahaja.\n\nbaca keseluruhan offer.\nfaham apa yang dia ajar.\nsemak apa yang kau dapat.\nkemudian baru decide dengan kepala sejuk",
    "aku lebih suka orang faham dulu sebelum beli.\n\nbaca salespage penuh.\ntengok sama ada masalah yang dia selesaikan memang masalah kau.\nsemak cara dia ajar dan apa yang diperlukan untuk execute",
    "jangan beli sebab takut tertinggal.\n\nbaca detail.\nbandingkan dengan apa yang kau perlukan sekarang.\nkalau ngam, baru jalan.\nkalau tak ngam, sekurang-kurangnya kau jelas kenapa",
    "kalau offer ini masih dibuka, gunakan masa untuk fahamkan dulu.\n\nbukan terus percaya.\nbukan terus menolak.\nbaca, semak dan nilai ikut keadaan kau sendiri",
  ],
});
...
function expandPromoteLines(lines, { personalBackground, product, angleNote, rng }) {
  ...
  const fillProduct = (value) => String(value || "").replace(/\{product\}/g, product);
  return [
    sentence(pick(OPERATOR_PROMOTE_FLOW.antiHype, rng)),
    personal ? sentence(personal) : "",
    sentence(fillProduct(pick(OPERATOR_PROMOTE_FLOW.potential, rng))),
    pick(OPERATOR_PROMOTE_FLOW.why, rng),
    pick(OPERATOR_PROMOTE_FLOW.notBecause, rng),
    sentence(pick(OPERATOR_PROMOTE_FLOW.operatorLens, rng)),
    angle ? sentence(`benda yang buat aku tengok dua kali, ${angle}`) : "",
    "kalau tengok sebagai operator, aku rasa ramai masih belum nampak apa yang sedang berlaku sekarang.",
    pick(OPERATOR_PROMOTE_FLOW.marketShift, rng),
    pick(OPERATOR_PROMOTE_FLOW.realProblem, rng),
    pick(OPERATOR_PROMOTE_FLOW.verdict, rng),
    "kalau tak ada strategi, lagi banyak effort yang dibuat, lagi banyak masa dan duit boleh bocor dekat tempat yang salah.",
    `sebab itu bila aku tengok ${product}, aku tak tengok produk sahaja. aku tengok cara berfikir yang cuba dibina dekat belakangnya.`,
    "untuk orang yang nak buat benda ni secara praktikal, benda paling mahal bukan sekadar template.\nbukan sekadar tools.\nbukan sekadar step-by-step.\n\ntapi cara berfikir.",
    pick(OPERATOR_PROMOTE_FLOW.strategy, rng),
    pick(OPERATOR_PROMOTE_FLOW.durableThinking, rng),
    pick(OPERATOR_PROMOTE_FLOW.review, rng),
...
function generateAdaptivePost(options = {}) {
  ...
  const maxChars = platform === "threads_general" ? 500 : 3800;
  ...
  for (let attempt = 0; attempt < 80; attempt += 1) {
    ...
    if (link) {
      const ending = `baca salespage penuh dekat sini,\n${link}\n\nkalau rasa posting ni bermanfaat,\nshare posting ni.`;
      text = `${trimTo(text, maxChars - ending.length - 2)}\n\n${ending}`;
    }
